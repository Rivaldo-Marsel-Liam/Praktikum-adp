...
# Data harga tiket berdasarkan maskapai dan kelas kursi
data_maskapai = {
...
# Diskon 20% jika beli lebih dari 3 tiket
if jumlah_tiket > 3:
    total_harga *= 0.8  
